...
<v-card-text>
    ...
    >
<v-tab :value="lhome" @click="$router.push('/moss/')">
<span class="text-regular">Moss </span> home
</v-tab>
...
<v-menu activator="parent">
  <v-list>
    <v-list-item
      ...
      :key="index"
      :value="index"
      @click="$router.push('/moss/table/'+item.idlink)"
    >
...
<!-- <v-tab value="moss_specimen_others">
      Others
      <v-menu activator="parent">
        <v-list>
          <v-list-item
...
<v-btn
    ...
    >
        ...
        >
          <v-list >
            <v-tab class="px-2" @click.stop="drawer = !drawer" value="lhome" @click="$router.push('/moss/')"><span class="text-regular">Moss </span><span class="px-0"> home</span> <!--v-icon icon="mdi-home-variant"></v-icon--></v-tab>
            <v-tab 
              value="hepaticmoss_species_main"
              @click="getAllMeta"
            >
            ...
            <v-menu activator="parent" location=center>
              <v-list>
                <v-list-item
                  ...
                  :key="index"
                  :value="index"
                  @click="$router.push('/moss/table/'+item.idlink), drawer = !drawer"
                >
                  <v-list-item-title>{{ item.title }}</v-list-item-title>
                </v-list-item>
              </v-list>
