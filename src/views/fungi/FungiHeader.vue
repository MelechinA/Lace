...
<v-card-text>
    ...
    >
<v-tab :value="lhome" @click="$router.push('/fungi/')">
<span class="text-regular">Fungi </span> home
</v-tab>

<v-tab 
  value="fungi_species_main"
  @click="getAllMeta"
>
Species
<v-menu activator="parent">
  <v-list>
    <v-list-item
      ...
      :key="index"
      :value="index"
      @click="$router.push('/fungi/table/'+item.idlink)"
    >
...
<!-- <v-tab value="fungi_specimen_others">
      Others
      <v-menu activator="parent">
        <v-list>
          <v-list-item
...
<v-btn
    ...
    >
        ...
        >
          <v-list >
            <v-tab class="px-2" @click.stop="drawer = !drawer" value="lhome" @click="$router.push('/fungi/')"><span class="text-regular">Hepatics </span><span class="px-0"> home</span> <!--v-icon icon="mdi-home-variant"></v-icon--></v-tab>
            <v-tab 
              value="fungi_species_main"
              @click="getAllMeta"
            >
            ...
            <v-menu activator="parent" location=center>
              <v-list>
                <v-list-item
                  ...
                  :key="index"
                  :value="index"
                  @click="$router.push('/fungi/table/'+item.idlink), drawer = !drawer"
                >
                  <v-list-item-title>{{ item.title }}</v-list-item-title>
                </v-list-item>
              </v-list>
