...
{{row}}
  ...
  <base-data-material v-bind="{mode:'view',column:meta, initValue:row[col.fieldname], meta:meta, rowobject:row}"></base-data-material>
                    ...
                    <base-data-material-singlesps v-bind="{mode:mode,meta:meta, value:row}"></base-data-material-singlesps>
                    </div>
...
import FishHeader from './FishHeader.vue';
//import BaseDataMaterial from '@/components/BaseDataMaterial.vue';
import BaseDataMaterialSinglesps from '@/components/BaseDataMaterialSinglesps.vue';
//    import BaseDataMaterialMultisps from '@/components/BaseDataMaterialMultisps.vue'
//import BaseDataMaterialMultispsTest from '@/components/BaseDataMaterialMultispsTest.vue';
//import BaseDataMaterialMultispsTest2 from '@/components/BaseDataMaterialMultispsTest2.vue';
//import BaseDataMaterial from '@/components/BaseDataMaterial.vue';
