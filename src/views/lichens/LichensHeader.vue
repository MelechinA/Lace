...
<v-card-text>
    ...
    >
<v-tab :value="lhome" @click="$router.push('/lichens/')">
...
<!-- 
<v-tab value="lichen_specimen_others">
      Others
      <v-menu activator="parent">
        <v-list>
          <v-list-item
...
<v-btn
    ...
    >
        ...
        >
          <v-list >
            <v-tab class="px-2" @click.stop="drawer = !drawer" value="lhome" @click="$router.push('/lichens/')"><span class="text-regular">Lichens </span><span class="px-0"> home</span> <!--v-icon icon="mdi-home-variant"></v-icon--></v-tab>
            <v-tab 
              value="lichen_species_main"
              @click="getAllMeta"
            >
